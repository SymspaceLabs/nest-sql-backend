...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.createUser = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.create(createUserDto)];
                    case 1:
                        newUser = _a.sent();
    ...
    UsersService.prototype.verifyUser = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.usersRepository.update(userId, { password: hashedPassword })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UsersService.prototype.saveResetToken = function (userId, token, expiry) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
