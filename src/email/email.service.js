                        ...
                        case 0:
                            ...
                            return [4 /*yield*/, this.transactionalClient.messages.send({
                                    message: {
                                        ...
                                        html: "<p>Please verify your email by clicking the following link: <a href=\"".concat(verificationUrl, "\">Verify Email</a></p>"),
                                    },
                                })];
                        case 1:
                            response = _a.sent();
                        ...
                        case 0:
                            ...
                            return [4 /*yield*/, this.transactionalClient.messages.send({
                                    ...
                                    message: {
                                        ...
                                        subject: 'Verify your email address',
                                        to: [{ email: email, type: 'to' }],
                                        html: "<p>Please verify your email by clicking the following link:</p></br>".concat(verificationUrl),
                                    },
                                })];
                        case 1:
                            response = _a.sent();
        ...
        MailchimpService_1.prototype.sendPasswordResetEmail = function (email, token) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            resetUrl = "http://your-domain.com/reset-password?token=".concat(token);
                            message = {
                                from_email: 'your-email@example.com',
