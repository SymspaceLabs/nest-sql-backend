...
var ProductsService = function () {
    ...
    var ProductsService = _classThis = /** @class */ (function () {
        function ProductsService_1(productRepository, productImageRepository, minioService) {
        ...
        ProductsService_1.prototype.create = function (createProductDto) {
            return __awaiter(this, void 0, void 0, function () {
                var buffer, timestamp, randomString, filename, resultUpload, prodImageNew, newProductInsert;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log('img', createProductDto.images);
                            timestamp = Date.now();
                            randomString = (0, uuid_1.v4)();
                            filename = "".concat(timestamp, "-").concat(randomString, "-").concat(createProductDto.images[0].originalname);
                            return [4 /*yield*/, this.minioService.uploadFile(createProductDto.images[0].buffer, filename)];
                        case 1:
                            resultUpload = _a.sent();
                            prodImageNew = {
                                imageUrl: filename,
                            };
                            this.productImages.push(prodImageNew);
                            newProductInsert = this.productRepository.create({
                            ...
                            return [2 /*return*/, newProductInsert];
                    }
                });
            });
        };
        ...
        ProductsService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.productRepository.findOneById(id)];
                        case 1:
                            product = _a.sent();
                            if (!product) {
        ...
        ProductsService_1.prototype.findOneProdImg = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var queryBuilder;
                return __generator(this, function (_a) {
                    queryBuilder = this.productImageRepository.createQueryBuilder('productImage');
        ...
        ProductsService_1.prototype.update = function (id, updateProductDto) {
            var productIndex = this.products.findIndex(function (prod) { return prod.id === id; });
            if (productIndex === -1) {
                throw new common_1.NotFoundException("Product with ID ".concat(id, " not found"));
            }
            var updatedProduct = __assign(__assign({}, this.products[productIndex]), updateProductDto);
        ...
        ProductsService_1.prototype.remove = function (id) {
            ...
            var removedProduct = this.products.splice(productIndex, 1);
