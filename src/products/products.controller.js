...
var ProductsController = function () {
    ...
    var _getFile_decorators;
    var _findAll_decorators;
    var _findOne_decorators;
    var _update_decorators;
    var _remove_decorators;
    var ProductsController = _classThis = /** @class */ (function () {
        function ProductsController_1(productsService, minioService) {
        ...
        ProductsController_1.prototype.getFile = function (bucket, filename, res) {
            return __awaiter(this, void 0, void 0, function () {
                var file, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.minioService.getFile(bucket, filename)];
                        case 1:
                            file = _a.sent();
        ...
        ProductsController_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var productDetail, productDetailImg, _i, productDetailImg_1, img, newLinkFile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.productsService.findOne(id)];
                        case 1:
                            productDetail = _a.sent();
                            return [4 /*yield*/, this.productsService.findOneProdImg(id)];
                        case 2:
                            productDetailImg = _a.sent();
                            _i = 0, productDetailImg_1 = productDetailImg;
                            _a.label = 3;
                        case 3:
                            if (!(_i < productDetailImg_1.length)) return [3 /*break*/, 6];
                            img = productDetailImg_1[_i];
                            return [4 /*yield*/, this.minioService.getFileUrl('ecomm-development', img.imageUrl)];
                        case 4:
                            newLinkFile = _a.sent();
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)('upload-product'), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file'))];
        _getFile_decorators = [(0, common_1.Get)(':bucket/:filename')];
        ...
        __esDecorate(_classThis, null, _getFile_decorators, { kind: "method", name: "getFile", static: false, private: false, access: { has: function (obj) { return "getFile" in obj; }, get: function (obj) { return obj.getFile; } }, metadata: _metadata }, null, _instanceExtraInitializers);
